...
public class Application_Methods extends General_Methods{
	...
	public void Logout(){
		...
		if(cssSelector("loginButtonCss").isDisplayed()){
			System.out.println("User Loggedout Successfully.");
			Reporter.log("User Loggedout Successfully.");
		}
		else{
			System.out.println("User Loggedout Unsuccessfully.");
			Reporter.log("User Loggedout Unsuccessfully.");
		}
	}
